...
they carry their own copy of the header markup. The generated pages get theirs
from build_classes.header(). This script pastes the generated nav back into
the four copies, so changing NEW_PAGES, DB_PAGES or the nav layout in
build_classes.py only ever needs doing once.

Run it after any nav change, then rebuild the generated pages.
"""
...
from build_classes import nav_desktop, nav_drawer
